  ...
  switch (props.view) {
    case DetailType.DRAWING:
      return props.drawings.length ? (
        <CollabImageComponent details={props.drawings} index={props.selectedIndex} />
      ) : (
    ...
    case DetailType.INSPIRATION:
      return props.inspirations.length ? (
        <CollabImageComponent details={props.inspirations} index={props.selectedIndex} />
      ) : (
        <CollabAlertComponent handleFileChanged={props.handleFileChanged}>
    ...
    case DetailType.FURNITURE:
      return props.furnitures.length ? (
        <CollabImageComponent details={props.furnitures} index={props.selectedIndex} />
      ) : (
        <CollabAlertComponent handleFileChanged={props.handleFileChanged}>
